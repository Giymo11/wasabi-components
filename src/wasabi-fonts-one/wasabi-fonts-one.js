class WasabiFontsOne extends Polymer.Element {

  static get is() {
    return 'wasabi-fonts-one';
  }
  ...
  static get properties() {
    return {
      ...
      fontweights: {
        type: Array,
        value() {
          return WasabiFontsOne.createFontweights();
        }
      }
    };
  }
...
customElements.define(WasabiFontsOne.is, WasabiFontsOne);
